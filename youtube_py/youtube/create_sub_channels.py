...
from youtube import switch_to_sub_channel
...
def create_sub_channels(
    ...
    time.sleep(5)
    for i, sub_channel in enumerate(sub_channels_list):
        print(f"[{i + 1}] Creating sub channel: {sub_channel['channel_name']}")
        ...
        channel_name_input.send_keys(sub_channel['channel_name'])
